                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr class="job-items">
                        ...
                        <td class="deadline">Oct 31, 2018</td>
              ...
              <div class="dashboard-sidebar">
                ...
                <div class="dashboard-menu">
                  <ul>
                    ...
                    <li><i class="fas fa-comment"></i><a href="employer-dashboard-message.php">Message</a></li>
                    <li><i class="fas fa-calculator"></i><a href="employer-dashboard-pricing.php">Pricing Plans</a></li>
                  </ul>
                  <ul class="delete">

              ...
              <div class="dashboard-content-wrapper container">
                <div class="manage-job-container">
                  <table class="table">
                    ...
                    <tbody>
                      <?php
                            $query = "select * from seleted_candidat WHERE uni_id='$job_uid' order by id desc";
                      ...
                      <tr class="job-items">
                        ...
                        <td class="deadline"><a href="seleted-job-application-details.php? $id=<?php echo $result['id']; ?>" >View Application</a></td>

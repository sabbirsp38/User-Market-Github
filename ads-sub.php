...
<?php include 'inc/templect/baner.php'; ?> 
            ...
            header("Location: 404.php") ;
             ...
             $id= $_GET['$id'];
                  ...
                  ?>
                      ...
                      $query = "select * from adds where p_sub_catagory =$id"; 
 ...
 <?php
                          $query = "select * from adds where p_sub_catagory =$id order by id desc limit $start_from, $per_page";
...
<?php }?>
 ...
 <?php
                     ...
                     <?php
                      echo " <li><a href='ads-sub.php?page=1'> ".$language['First_Page']." </a></li>";

                      for ($i=1; $i<= $total_page; $i++) { 
                       echo "<li><a class='page-numbers' href='ads-sub.php?page=".$i." '>".$i. "</a></li>";
                       } 


                       echo "<li><a href='ads-sub.php?page=$total_page'> ".$language['Last_Page']. " </a></span></li>"?>
